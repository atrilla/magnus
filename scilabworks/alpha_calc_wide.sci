...
function alpha=alpha_calc_wide(fc,fsamp)
	...
	// value of alpha.
	//
	// This algorithm corresponds to the extension
	// of the equation proposed in the article.

	fcprima=(16000./fsamp).*fc;

	alpha=-0.000245.*fcprima + 0.97;
