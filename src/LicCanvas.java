...
/**
 * The class <it>LicCanvas</it> defines the canvas where
 * the license  banner will be placed.
 * @author Alexandre Trilla (atrilla@xtec.cat, st12809@salle.url.edu)
 */

public class LicCanvas extends Canvas {

    /**
     * This is the constructor for <it>LicCanvas</it>.
     */

    public LicCanvas() { //constructor
        super();
    }
    ...
    public void paint (Graphics g) {
        ...
        URL url=getClass().getResource("llicencia.png");
