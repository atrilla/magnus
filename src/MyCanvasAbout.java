...
/**
 * The class <it>MyCanvasAbout</it> defines the canvas where all
 * the information elements will be placed.
 * @author Alexandre Trilla (atrilla@xtec.cat, st12809@salle.url.edu)
 */

public class MyCanvasAbout extends Canvas {

    /**
     * This is the constructor for <it>MyCanvasAbout</it>.
     */

    public MyCanvasAbout() { //constructor
        super();
    }

    /**
     * This is the main method for painting the <it>MyCanvasAbout</it>.
     * @param g Graphics: This is the graphical environment.
     */

    public void paint (Graphics g) {
        Toolkit toolkit=Toolkit.getDefaultToolkit();
        URL url=getClass().getResource("about_img.png");
