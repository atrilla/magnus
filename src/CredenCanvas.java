...
/**
 * The class <it>CredenCanvas</it> defines the canvas where
 * the credentials  banner will be placed.
 * @author Alexandre Trilla (atrilla@xtec.cat, st12809@salle.url.edu)
 */

public class CredenCanvas extends Canvas {

    /**
     * This is the constructor for <it>CredenCanvas</it>.
     */

    public CredenCanvas() { //constructor
        super();
    }
    ...
    public void paint (Graphics g) {
        ...
        URL url=getClass().getResource("credencials.png");
