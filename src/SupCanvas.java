...
/**
 * The class <it>SupCanvas</it> defines the canvas where
 * the support banner will be placed.
 * @author Alexandre Trilla (atrilla@xtec.cat, st12809@salle.url.edu)
 */

public class SupCanvas extends Canvas {

    /**
     * This is the constructor for <it>MyCanvasAbout</it>.
     */

    public SupCanvas() { //constructor
        super();
    }
    ...
    public void paint (Graphics g) {
        ...
        URL url=getClass().getResource("suport.png");
