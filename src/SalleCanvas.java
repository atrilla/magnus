...
/**
 * The class <it>SalleCanvas</it> defines the canvas where
 * the La Salle University banner will be placed.
 * @author Alexandre Trilla (atrilla@xtec.cat, st12809@salle.url.edu)
 */

public class SalleCanvas extends Canvas {

    /**
     * This is the constructor for <it>MyCanvasAbout</it>.
     */

    public SalleCanvas() { //constructor
        super();
    }
    ...
    public void paint (Graphics g) {
        ...
        URL url=getClass().getResource("salle.png");
